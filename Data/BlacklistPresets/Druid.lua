-- Druid blacklist presets: item names this class auto-passes (skipped before the
-- roll popup), shown under "Blacklist presets" in the Options tab -- only for a Druid.
...
addon:AddBlacklistPreset("DRUID", "Druid", {
...
addon:AddBlacklistPreset("DRUID", "Druid Feral", {
    "Shoulderguards of the Undaunted",
    "Sabatons of Sudden Reprisal",
    "Bracers of the Tyrant",
    "Fire-Scorched Greathelm",
...
addon:AddBlacklistPreset("DRUID", "Druid Balance/Resto", {
    "Shoulderguards of the Undaunted",
    "Sabatons of Sudden Reprisal",
    "Bracers of the Tyrant",
    "Fire-Scorched Greathelm",
