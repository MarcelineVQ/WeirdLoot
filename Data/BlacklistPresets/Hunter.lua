-- Hunter blacklist presets: item names this class auto-passes (skipped before the
-- roll popup), shown under "Blacklist presets" in the Options tab -- only for a Hunter.
...
addon:AddBlacklistPreset("HUNTER", "Hunter", {
